...
import { BaseEntry, BrokenEntry, createBaseEntry, createBrokenEntry, LeafEntry } from "./entry.js";
...
export class ExerciseLoader extends EntryLoader<ExerciseFrontMatter, ExerciseEntry> {
  protected buildFsPath(parentBase: BaseEntry, folderName: string): string {
    return path.join(parentBase.fsPath, '..', folderName.replace('>', '/'));
  }
  ...
  protected async loadEntry(
    baseEntry: BaseEntry, frontMatter: ExerciseFrontMatter, position: number
...
export class ExerciseProvider extends BaseResourceProvider<
  LessonSectionProvider, ExerciseEntry | BrokenEntry, never
> {
  private markdownProcessor: MarkdownProcessor;

  constructor(
    parent: LessonSectionProvider,
    entry: ExerciseEntry | BrokenEntry,
    position: number,
    crumbs: Crumbs,
